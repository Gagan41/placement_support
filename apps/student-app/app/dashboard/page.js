...
const BAR_COLORS = ['bg-blue-600', 'bg-indigo-600', 'bg-cyan-600', 'bg-teal-600', 'bg-purple-600', 'bg-pink-600'];
...
export default function StudentDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#e8edff] flex overflow-hidden">
      ...
      <img 
        src="https://lh3.googleusercontent.com/u/0/d/1L3VgOO_GM6WiHFZPn045tP46O9PN2tDT" // Replace with your actual logo path
        alt="Platform Logo" 
      ...
      <div className="absolute -inset-1 bg-blue-100 rounded-full blur opacity-25" />
        ...
        <nav className="space-y-4 text-slate-600">
          ...
          <SidebarItem icon={<TrendingUp size={18} />} label="Ranking" />
        </nav>
        ...
        {showAddForm && selectedDate && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl p-6 max-w-md w-full max-h-96 overflow-y-auto">
              ...
              {/* Existing Events */}
              <div className="mb-6">
                <h4 className="text-xs font-semibold text-slate-600 mb-3">Events</h4>
              ...
              <div className="border-t border-slate-200 pt-4">
                <h4 className="text-xs font-semibold text-slate-600 mb-3">Add New Event</h4>
                <input
                  type="text"
  ...
  return (
    <div className="bg-white rounded-2xl p-3 shadow border border-slate-200">
      <div className="flex items-center justify-between mb-0.5">
        <h3 className="text-base font-bold text-slate-900">{months[currentDate.getMonth()]} {currentDate.getFullYear()}</h3>
      ...
      <div className="grid grid-cols-7 gap-2 mb-1">
        {daysOfWeek.map(day => (
          <div key={day} className="text-center text-[10px] font-bold text-blue-600 py-1 uppercase tracking-wider">{day}</div>
        ))}
      </div>
